...
- Post-baseline doctrine control: the bright line beginning `It cannot use a coherence measure to withdraw necessities already guaranteed` carries the 2026-08-12 CTD-0005 ruling. It is not a baseline quotation. It must preserve equal vote weight and the 2026-08-20 CTD-0006 ruling that biometric-derived personal records never inform stewardship or governance standing. Public-meeting sensing remains a provisional process-support experiment under private, unanimous, meeting-specific consent, with ephemeral aggregate output and no penalty for refusal.
...
- Open author decisions: the exact institutional form, funding, goods, reserves, jurisdiction, scarcity rules, and remedies for the staged material floor; whether COHERENCE records relation or is identical with it; and which epigraphs are quotations rather than adaptations. The 2026-08-12 CTD-0005 ruling forbids coherence evidence from changing voting rights or creating superior political standing. The 2026-08-20 CTD-0006 ruling removes biometric-derived personal records from stewardship and governance decisions while permitting only the bounded public-meeting experiment named above.
