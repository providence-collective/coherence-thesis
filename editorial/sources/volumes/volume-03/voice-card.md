...
- Post-baseline doctrine control: the bright line beginning `It cannot use a coherence measure to withdraw necessities already guaranteed` carries the 2026-08-12 CTD-0005 ruling. It is not a baseline quotation. It must preserve equal vote weight and the 2026-08-22 CTD-0006 clarification. People choosing stewards may consider a participant's voluntarily disclosed, scoped, role-relevant, privacy-preserving evidence derived from a participant-held record of limited biometrics and consented reflections as one input into whether their presence repeatedly helps people around them become more regulated and well. The evidence cannot decide the result, become its sole basis, establish a physiological ideal, or create an adverse inference when withheld. Accessible non-biometric evidence must carry equal standing. Public-meeting sensing remains a separate provisional experiment under private, unanimous, meeting-specific consent from everyone present, with no activation when a response is readily inferable, ephemeral aggregate output, and no penalty for refusal.
...
- Open author decisions: the exact institutional form, funding, goods, reserves, jurisdiction, scarcity rules, and remedies for the staged material floor; whether COHERENCE records relation or is identical with it; and which epigraphs are quotations rather than adaptations. The 2026-08-12 CTD-0005 ruling forbids coherence evidence from changing voting rights or creating superior political standing. The 2026-08-22 CTD-0006 clarification permits only the bounded, voluntary stewardship evidence and public-meeting experiment named above; implementation remains unproved.
