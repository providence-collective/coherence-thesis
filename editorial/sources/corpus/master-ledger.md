...
- Non-biometric attestations may inform appointment, delegation, role scope, review, or removal for bounded stewardship when the evidence is relevant to the work, optional, contestable, and available through an equal non-biometric route. Biometric-derived personal records may not inform those decisions or any person's governance standing, chamber eligibility, deliberative access, speaking rights, agenda rights, decision weight, or vote.
- A public governance meeting may explore live physiological sensing only when every affected participant privately and affirmatively consents for that specific meeting. Unanimity governs activation of sensing, not whether the meeting proceeds. Refusal, abstention, absence of consent, late arrival without consent, or withdrawal keeps sensing off or stops it while the meeting continues without penalty.
...
- This meeting rule is provisional. Research reports possible benefits for relational awareness and group performance, but effects are small, heterogeneous, and context-sensitive. The experiment remains bounded until evidence and affected participants show a more coherent way to protect dignity while learning from collective regulation.
